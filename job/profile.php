...
$sql="update user set fname=:name,contact=:mobileno where email=:email";
...
{	?>
	...
	<p style="width: 350px;">
			...
			<b>Name</b>  <input type="text" name="name" value="<?php echo htmlentities($result->fname);?>" class="form-control" id="name" required="">
	</p> 
